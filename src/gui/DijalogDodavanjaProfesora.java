...
public class DijalogDodavanjaProfesora extends JDialog{
	...
	public DijalogDodavanjaProfesora(Frame parent, String title, boolean modal) {
	    ...
	    gbcLblAdresaKancelarije.insets = new Insets(20, 0, 0,0);
	    ...
	    gbcLblBrLicneKarte.insets = new Insets(20, 0, 0,0);
	    ...
	    gbcLblZvanje.insets = new Insets(20, 0, 0,0);
	    ...
	    gbcLblGodineStaza.insets = new Insets(20, 0, 0,0);
	    ...
	    gbcTxtGodineStaza.insets = new Insets(20, 20, 0, 20);
